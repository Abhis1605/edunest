...
export default function AttendancePage() {
    ...
    const fetchAttendance = async () => {
        ...
        if (selectedDate > today) {
            toast.error('Cannot take attendance for future dates')
            return
        }
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-border bg-accent/30">
                                    ...
                                    <th className="text-right text-xs font-medium text-muted-foreground px-5 py-3 w-40">Attendance</th>
                                </tr>
                            </thead>
                            <tbody>
                                        ...
                                        <td className="px-5 py-3">
                                            <div className="flex items-center justify-end gap-2">
                                                <button
                                                    ...
                                                    className={`px-3 py-1 rounded-md text-xs font-semibold transition-colors disabled:cursor-default ${
