...
export default function LoginPage() {
        ...
        <div className="min-h-screen flex items-center justify-center bg-[#699640] ">
            ...
            <div className="bg-white p-8 rounded-xl shadow-md w-full max-w-sm">
                ...
                <div className="flex justify-center mb-5">
                    <Image src='/Images/logo.png' alt="EduNest-Logo" width={150} height={80} className="object-contain"
                     />
                </div>
    ...
    <div className="relative">
        <input
            ...
            className="w-full px-4 py-2 pr-10 mb-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#16737E] text-black"
        />
        ...
        >
            { showPassword ? <EyeOff className="w-5 h-5 text-[#699640]" /> : <Eye className="h-5 w-5" />}
        </button>
    </div>
</div>
